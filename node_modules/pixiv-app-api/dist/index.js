...
class PixivApp {
    ...
    async login(username, password) {
        ...
        console.log(querystring_1.stringify(decamelize_keys_1.default(data)));
        console.log({ headers });
        console.log(axios_1.headers)

        const axiosResponse = await axios_2.default.post('https://oauth.secure.pixiv.net/auth/token', "client_id=MOBrBDS8blbauoSck0ZfDbtuzpyT&client_secret=lsACyCD94FhDUtGTXi3QzcFE2uU1hqtDaKeqrdwj&get_secure_url=1&grant_type=password&refresh_token=&username=vietanh.28062000%40gmail.com&password=nguyenlevietanh", { headers: { 'X-Client-Time': '2019-12-16T04:14:11+00:00',
        'X-Client-Hash': '3e999ef3649adcfebb6622e2a7416a6a' } });
